            ...
            <div class="col-md-6 my-auto">
                <div class="d-grid justify-content-center align-content-center">
                    ...
                    <form method="POST" action="{{ request()->url() }}" class="needs-validation" novalidate
                        autocomplete="off">
                        @csrf
                        <h4 class="fw-semibold mb-5">Password Reset!</h4>
                        <div class="form-group">
                            <label for="new_password" class="form-label text-muted">New Password</label>
                            <input type="password" name="new_password" id="new_password"
                                class="form-control rounded-pill" placeholder="New Password" autocomplete="off"
                                required>
                            @error('new_password')
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="confirm_password" id="confirm_password"
                                class="form-control rounded-pill" placeholder="Confirm Password" autocomplete="off"
                                required>
                            @error('confirm_password')
                                <span class="text-danger fs-9">{{ $message }}</span>
                            @enderror
                        </div>
                        <button type="submit" class="btn btn-secondary w-100 mb-5">Reset Password</button>
